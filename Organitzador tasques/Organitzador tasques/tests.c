...
//Llegim una nova tasca i 3 comentaris, els inserim i n'eliminem un per comprovar
//que les funcions insereix_comentari i elimina_comentari funcionen correctament.
void tests_tasca2() {
    printf("\n--- INICI TEST TASCA 2 ---\n");
...
//Llegim una carpeta, una data i 3 tasques. Inserim la data a la carpeta i les tasques
//a la data. Despres eliminem una tasca per comprovar que funciona elimina_tasca.
//Al mostrar la carpeta, les tasques han d'apareixer ordenades per prioritat decreixent.
void tests_carpeta2() {
...
//Llegim una carpeta i 3 dates buides. Les inserim a la carpeta i despres cridem
//neteja_dates_buides. La carpeta ha de quedar sense cap data.
void tests_carpeta3() {
