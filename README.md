# Organitzador de Tasques Pendents (PRD)

Aquest és el projecte de laboratori de Programació i Estructures de Dades (PRD) desenvolupat en C. L'aplicació és un organitzador de tasques tipus agenda amb una interfície textual.
